...
void SAMPLE_VDA_Usage(char *sPrgNm)
{
    ...
    printf("index:\n");
    printf("\t 0) VI:1*D1 MD+OD.\n");
    printf("\t 1) VI:16*MixCap MD+OD. .\n");			
    return;
}
